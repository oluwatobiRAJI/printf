		...
		int width, int precision, int size)
{
	...
	return (write_pointer(buffer[i], ind, length, width,
				flags, padd, extra_c, padd_start));
}

/**
 * print_non_printable - Print ascii cides in hex of non printable chars
 * @types: Lists of arguments
